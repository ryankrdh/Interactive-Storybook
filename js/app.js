...
const book = [];
const dog = {};
const allScroll = document.getElementById('scroll');
dog.items = [];
...
const boneEat = new Audio('sounds/bone_eat.mp3');
const softEat = new Audio('sounds/soft_food.mp3');
const angryBark = new Audio('sounds/Angry_bark.mp3');
const happyBark = new Audio('sounds/happy_bark.mp3');
const water = new Audio('sounds/water.mp3');
const running = new Audio('sounds/running.mp3');
const petDoor = new Audio('sounds/pet_door_open.mp3');
const cat = new Audio('sounds/cat.mp3');
const yelp = new Audio('sounds/yelp.mp3');
const bowlEat = new Audio('sounds/bowl_eat.mp3');
const churchBackground = new Audio('sounds/Church_street.mp3');
const beachBackground = new Audio('sounds/beach.mp3');
const bed = new Audio('sounds/bed.mp3');
const pigeons = new Audio('sounds/pigeons.mp3');
const seagulls = new Audio('sounds/seagulls.mp3');
...
function faintedDog() {
	...
	const displayName = document.getElementById('charName-id');
...
const waterOBJ = new ItemOBJ('water', 'img-item-water');
const woundOBJ = new ItemOBJ('wound', 'img-item-wound');
const bowlOBJ = new ItemOBJ('bowl', 'img-item-bowl');
const sausageOBJ = new ItemOBJ('sausage', 'img-item-sausage');
const meatOBJ = new ItemOBJ('meat', 'img-item-meat');
const sleepOBJ = new ItemOBJ('sleep', 'img-item-sleep');

function giveAction(OBJ) {
	const itemOBJid = OBJ.id;
	dog.items.push(OBJ);
	...
	if (dog.hitPoints <= 0) {
		...
		for (let i = 0; i < book.length; i++) {
			if (book[i].sceneNumber === sceneToRender) {
				...
				const sceneText1 = document.createElement('li');
...
function doHunger(damage) {
	...
	const damageScroll = document.getElementById('scroll');
	const sceneDamage1 = document.createElement('li');
...
function loseEnergy(damage) {
	...
	if (damage > dog.energyHP) {
		const damageRemainder = damage - dog.energyHP;
...
const bowlSlot = document.getElementById('img-item-bowl');
const waterSlot = document.getElementById('img-item-water');
const woundSlot = document.getElementById('img-item-wound');
const meatSlot = document.getElementById('img-item-meat');
const sausageSlot = document.getElementById('img-item-sausage');
const sleepSlot = document.getElementById('img-item-sleep');
...
function battle(dog, enemy) {
	play(yelp);
	const enemyBattleHp = enemy.hitPoints;
	while (enemyBattleHp > 0 && dog.hitPoints > 0) {
		doDamage(enemy.attackPower);
		enemyBattleHp = enemyBattleHp - dog.attackPower;
		const dogDamageScroll = document.getElementById('scroll');
		const sceneDamage2 = document.createElement('li');
